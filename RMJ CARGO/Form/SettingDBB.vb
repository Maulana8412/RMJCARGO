...
Public Class SettingDBB
    ...
    Private Sub LookUpEdit1_GotFocus(sender As Object, e As EventArgs)
        Try
            ...
            Using con As MySql.Data.MySqlClient.MySqlConnection = New MySql.Data.MySqlClient.MySqlConnection(conString)
                con.Open()

                Using cmd As MySql.Data.MySqlClient.MySqlCommand = New MySql.Data.MySqlClient.MySqlCommand("SHOW DATABASES", con)
    ...
    Private Sub SettingDBB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
