...
Public Class FRMKARYAWAN
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        Try
            ...
            Else
                MySQLcmd = New MySqlCommand("SELECT * FROM karyawan WHERE NIK=@NIK ", MySQLconn)
                With MySQLcmd
                ...
                If MySQLdr.HasRows Then
                    p = CType(MsgBox("NIK sudah terdaftar, " &
                                     "Apakah Ingin Melanjutkan???", vbYesNo), String)
                    If p = vbYes Then
                        MySQLdr.Close()

                        MySQLcmd = New MySqlCommand("DELETE FROM karyawan WHERE NIK='" &
                                                  TextEdit1.Text & "'", MySQLconn)
                        MySQLcmd.ExecuteNonQuery()

                        MySQLcmd = New MySqlCommand("INSERT INTO karyawan(NIK, " &
                                                                         "NAMA, " &
                                                                         "TGLMASUK, " &
                                                                         "JABATAN, " &
                                                                         "USERNAME)VALUES(@NIK, " &
