...
Public Class FrmPelangganEdit
    Private Sub FrmPelangganEdit_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        MdiParent = MenuUtama
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        Try
            ...
            Else
                MySQLcmd = New MySqlCommand("UPDATE pelanggan set NAMAPELANGGAN=@NAMAPELANGGAN, " &
                                          "ALAMAT1=@ALAMAT1, " &
                                          "ALAMAT2=@ALAMAT2, " &
                                          "KOTA=@KOTA, " &
                                          "TELEPON=@TELEPON, " &
                                          ...
                                          "TINGKAT=@TINGKAT, " &
                                          "STATUS=@STATUS, " &
                                          "USERNAME=@USERNAME WHERE NOPELANGGAN=@NOPELANGGAN", MySQLconn)
                With MySQLcmd
